                            ...
                            <div class="row row-cols-3 row-cols-md-4 g-4">
                                ...
                                <div class="col">
                                    <div class="card bg-danger">
                                        <div class="card-body d-flex flex-column">
                                            <img src="img/polo-hombre.png" class="card-img-top" alt="...">
                                            <button type="button" class="btn btn-light mt-auto align-self-center">Otro 5</button>                          
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="card bg-danger">
                                        <div class="card-body d-flex flex-column">
                                            <img src="img/polo-hombre.png" class="card-img-top" alt="...">
                                            <button type="button" class="btn btn-light mt-auto align-self-center">Otro 6</button>                          
                                        </div>
                                    </div>
                                </div>
