                ...
                <div class="compra">
                    <div class="row">
                        <div class="col fecha-c">
                            <h5>Aquí va la fecha de la compra</h5>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-5 nombre-c">
                            <div>
                                <h6 class="text-danger">Camiseta Eco Estampada para Hombre Freedom 02269 - Negro M</h6>
                            </div>
                            <div class="nombre-p">
                                <p><span>6 </span>unidades</p>
                            </div>
                        </div>

                        <div class="col-md-2 estado-c">
                            <div>
                                <h5 class="text-success">Estado de la entrega</h5>
                            </div>
                            <div class="estado-p">
                                <p>En camino</p>
                            </div>
