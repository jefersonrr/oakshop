                    ...
                    <tbody>
                        <%
                            ...
                            if(persona.getIdRol().getId() == 2){
                                String nombre = persona.getNombre().split(" ")[0] + " " + persona.getApellido().split(" ")[0];   
                        %>
                        <tr>
                            ...
                            <td>
                                <div class="icons-acciones">
                                    <div>
                                        <button type="button" style="background: transparent" class="fas fa-edit" data-bs-toggle="modal" data-bs-target="#modal2" data-bs-whatever = "<%=persona.getContraseña()%>"></button>
                                    </div>
                            ...
                            <div class="row text-center m-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <input type="text" class="form-control " id="recipient-name" name="nombre" readonly required>
