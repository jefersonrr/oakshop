...
public class ActualizarPublicacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idImgs[] = request.getParameter("idImagenes").split(",");
        
        //publicacion
        PublicacionDAO p = new PublicacionDAO();
        String idpublic = request.getSession().getAttribute("editar").toString();
        int idP = Integer.parseInt(idpublic);
        ...
        int categoria = pu.getIdCategoria().getId();
        int tipo = pu.getIdTipo().getId();
        
        a.actualizarPublicacion(idP,nombre,marca,categoria,tipo,descripcion,referencias,costos,descuentos,tallas,imgs,colores,cantidades,idProductos,idImgs);
