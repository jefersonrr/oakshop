...
public class adminUpdateCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            perEditar.setNombre(nombres);
            perEditar.setApellido(apellidos);
            perEditar.setCedula(cedula);
            perEditar.setCorreo(correo);
            perEditar.setTelefono(telef);
            perEditar.setContraseña(contrasenia);
            perEditar.setDireccion(direccion);
            p.update(perEditar);
            System.out.println(perEditar.getCorreo());
