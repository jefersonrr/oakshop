...
public class Calificacion implements Serializable {
    ...
    public Calificacion(CalificacionPK calificacionPK, Date fecha, int valor, String comentario) {
        this.calificacionPK = calificacionPK;
        this.fecha = fecha;
        this.valor = valor;
    ...
    public Calificacion(String idCliente, int idProducto) {
        this.calificacionPK = new CalificacionPK(idCliente, idProducto);
    }
